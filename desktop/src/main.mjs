...
const routes = {
  ...
  syncPlaneProject: ["POST", "/v1/integrations/plane/sync", (p) => p],
  createPlaneWorkItem: ["POST", "/v1/integrations/plane/work-items", (p) => p],
  updatePlaneWorkItem: ["POST", "/v1/integrations/plane/work-items/update", (p) => p],

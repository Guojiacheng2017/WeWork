...
contextBridge.exposeInMainWorld("weworkHost", {
  ...
  syncPlaneProject: (input) => invoke("syncPlaneProject", input),
  createPlaneWorkItem: (input) => invoke("createPlaneWorkItem", input),
  updatePlaneWorkItem: (input) => invoke("updatePlaneWorkItem", input),

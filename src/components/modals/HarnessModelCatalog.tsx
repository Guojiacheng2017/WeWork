...
export function HarnessModelCatalog({ harness, setHarness, installations, models, draft, setDraft, saving, save, chooseDefault, status }: {
  ...
  return <section className="rounded-xl border border-slate-200 p-4">
    ...
    {status && <p role="status" className="mt-2 rounded-lg bg-amber-50 px-3 py-2 text-[11px] leading-5 text-amber-800">{status}</p>}
